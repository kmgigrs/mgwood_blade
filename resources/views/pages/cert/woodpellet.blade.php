...
@section('title', 'Wood Pellet - Certificate')
<!-- isi bagian konten -->
@section('content')
  <style>
    .splide__slide img {
  ...
  <div class="flex w-full justify-center mx-auto max-w-7xl my-2">
    <div class="bg-secondary m-5 container min-h-full">
      <h3 class="font-libre font-extrabold flex flex-col text-3xl text-left leading-tight text-primary my-1">
        Wood Pellet Reports of Analysis
      </h3>
      <div class="mb-5">
          ...
          <div class="splide__track">
            <ul class="splide__list">
              <li class="splide__slide">
                <img src="{{ asset('assets/images/cert/WOODPELLET/Wood Pellet sucofindo-09-2024_unlocked.jpg') }}"
                  alt="">
              </li>
            </ul>
          </div>

          ...
          <div class="splide__track">
            <ul class="splide__list">
              <li class="splide__slide">
                <img src="{{ asset('assets/images/cert/FSC/fsc.1.jpg') }}" alt="">
              </li>
              <li class="splide__slide">
                <img src="{{ asset('assets/images/cert/FSC/fsc.2.jpg') }}" alt="">
              </li>
              <li class="splide__slide">
                <img src="{{ asset('assets/images/cert/FSC/fsc.3.jpg') }}" alt="">
              </li>
            </ul>
          </div>
        </section>

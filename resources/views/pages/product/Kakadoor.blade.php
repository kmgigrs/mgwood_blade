    ...
    <div class="bg-secondary m-5 container min-h-full">
      ...
      <div class="flex w-full flex-col md:flex-row">
        <div class="w-full mx-0 md:mx-2 my-4 md:my-0">
          <img class="object-contain h-full w-full max-h-[125vh] lg:max-h-[110vh]"
            src="{{ asset('assets/images/products/kaka/homepage_pintu.png') }}" loading="lazy" />
        </div>
      </div>
      <div class="card mt-5 max-w-full bg-slate-100 shadow-xl text-black">
        <div class="card-body">
          ...
          <div class="mb-5">
            ...
            <ul class="list-disc list-inside">
              <li>
                <a href="/certificate/sni" target="_blank">SNI 01-6243.1-2000</a>
              </li>
              <li>
                <a href="/certificate/iso-9001" target="_blank">ISO 9001:2015</a>
              </li>
            </ul>
          </div>
          <div class="mb-5">
            <p class="font-semibold text-2xl">Series</p>
            <ul class="list-disc list-inside">
              <li>NC (Natural Colour) Series</li>
              <li>SC (Solid Colour) Series</li>
              <li>MD (Minimalis Door) Series</li>
              <li>Premium Door Series</li>
            </ul>
          </div>
          <div class="mb-5 flex flex-col md:flex-row items-center">
            <div class="mb-5 md:mb-0 md:mr-5">
              <a href="https://kakadoor.com/product/pintu" target="_blank" class="btn btn-active btn-primary text-black">
                More About KAKA Door
              </a>
            </div>
            <div>
              <a href="https://tokopedia.link/pv9MgpDO5sb" target="_blank"><button
                  class="btn btn-outline btn-success flex items-center"> Order at <svg class="w-auto h-1/2 ml-2"
                    width="400" height="87" version="1.1" viewBox="0 0 400 87" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path
                      ...
                      style=" fill-rule: evenodd; fill: #42b549; stroke-width: 2.837; " />
                  </svg>
                </button>
              </a>
            </div>
